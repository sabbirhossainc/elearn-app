<template>
    ...
    >
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                class="mt-8 flex-col text-center justify-center items-center bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg"
            >
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        <h1
                            class="text-3xl font-bold underline text-orange-300"
                        >
                            Hello world!
                        </h1>
                    </div>
